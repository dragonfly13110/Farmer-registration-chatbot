...
- ดูลำดับความสำคัญ เช่น ถ้าเกษตรบอกว่าปลูกอะไร ให้ดูจำนวนพื้นที่ก่อนว่าปลูกกี่ไร่ ถ้าพื้นที่ไม่ถึงที่กำหนดให้ไปดูรายได้
...
- คำถามแรกๆ ที่ควรถามคือ เป็นเกษตรกรรายเดิม หรือเกษตรกรายใหม่ หรือเพิ่มแปลง เป็นที่ตัวเองหรือที่เช่า จากนั้นให้ถามข้อมูลประมาณว่า ทำการเกษตรอะไร กี่ไร่ ปลูกอะไร และมีรายได้เท่าไหร่
