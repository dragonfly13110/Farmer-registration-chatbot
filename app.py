...
- แปลงภาษาพูดให้เป็นภาษาที่เป็นทางการมากขึ้น จากนั้น รวมบริบทที่สำคัญจากบทสนทนาก่อนหน้าเข้ามาในคำค้นหาใหม่"""),
...
4.  **ทุกครั้ง ถ้ามีการถามว่าปลูกสิ่งต่าง ๆ แล้วขึ้นทะเบียนได้ไหม ให้แนะนำเรื่องพื้นที่ปลูกขั้นต่อของพืชนั้นๆ และถ้ามีจำนวนต้นขั้นต่ำ/พื้นที่ ก็ให้แนะนำด้วย แต่ถ้าคุณพิจารณาคำถามแล้ว อาจจะไม่ถึงพื้นที่ขั้นต่ำ ให้แนะนำเรื่องข้อยกเว้นเรื่องรายได้ 
