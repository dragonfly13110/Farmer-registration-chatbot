...
13. **ถาม:** "พี่น้องที่อยู่คนละทะเบียนบ้านกัน แต่ทำเกษตรในที่ดินแปลงเดียวกันที่ยังไม่ได้แบ่งโฉนด จะสามารถแยกกันขึ้นทะเบียนคนละครัวเรือนได้หรือไม่?"
    ...
    > 2.  **สำหรับผู้ที่ไม่มีชื่อเป็นเจ้าของที่ดิน:** อีกฝ่ายหนึ่งจะต้องมาขึ้นทะเบียน โดยระบุประเภทการถือครองเป็น **"เช่า"** หรือ **"อื่นๆ (ใช้ประโยชน์โดยไม่มีค่าเช่า)"** ซึ่งจะต้องมีเอกสารประกอบคือ **"หนังสือสัญญาเช่า"** หรือ **"หนังสือยินยอมให้ใช้ประโยชน์ในที่ดิน"** ที่เจ้าของที่ดิน (ซึ่งก็คือพี่/น้องอีกคน) เป็นผู้ลงนามให้ครับ
...
11. **ถาม:** "ถ้าพลาดช่วงเวลาการขึ้นทะเบียนข้าวนาปีไปแล้ว จะมีผลอะไรบ้าง?"
    > **ตอบ:** ผลกระทบที่ชัดเจนที่สุดคือ หากในปีการผลิตนั้นมีโครงการช่วยเหลือจากภาครัฐที่เกี่ยวข้องกับข้าวนาปี เช่น โครงการประกันรายได้ หรือการช่วยเหลือภัยพิบัติ ท่านจะไม่สามารถเข้าร่วมโครงการหรือรับการช่วยเหลือเหล่านั้นได้ เพราะไม่มีข้อมูลของท่านอยู่ในระบบสำหรับปีการผลิตนั้นครับ **โดยเฉพาะอย่างยิ่งสำหรับภัยพิบัติ การขึ้นทะเบียนจะต้องเสร็จสิ้นก่อนวันที่เกิดภัยเสมอ**
12. **ถาม:** "ผมปลูกข้าวอายุ 40 วันแล้วโดนน้ำท่วม แต่ยังไม่ได้ไปขึ้นทะเบียนเลย แบบนี้จะยังไปแจ้งเพื่อรับเงินช่วยเหลือได้ไหม?"
    > **ตอบ:** เป็นสถานการณ์ที่น่าเห็นใจอย่างยิ่งครับ แต่ตามหลักเกณฑ์การช่วยเหลือผู้ประสบภัยพิบัติของภาครัฐ การขึ้นทะเบียนเกษตรกรสำหรับกิจกรรมนั้นๆ **จะต้องดำเนินการให้เสร็จสิ้นเรียบร้อย "ก่อน" วันที่เกิดภัยพิบัติ** เท่านั้นครับ 
    > ในกรณีของท่าน แม้ว่าอายุข้าว 40 วันจะยังอยู่ในกรอบเวลาที่สามารถแจ้งขึ้นทะเบียนได้ตามปกติ (15-60 วัน) แต่เนื่องจากภัยพิบัติได้เกิดขึ้นแล้ว จึงทำให้ท่าน **ไม่เข้าเกณฑ์ที่จะได้รับความช่วยเหลือเยียวยา** สำหรับความเสียหายในครั้งนี้ครับ อย่างไรก็ตาม ท่านยังควรไปแจ้งขึ้นทะเบียนไว้ เพื่อรักษาสิทธิ์สำหรับโครงการอื่นๆ ในอนาคตครับ 
