...
*   **ความสำคัญ:** ต้องนำมาแสดงเพื่อยืนยันสิทธิ์ในการเข้าทำประโยชน์ในที่ดินแปลงนั้นๆ โดยเอกสารที่ต้องเตรียมจะแตกต่างกันไปตามประเภทการถือครอง ดังนี้:
    ...
    *   **ก) กรณีเป็นที่ดินของตนเองหรือคนในครัวเรือน:**
...
*   **ตัวอย่างหนังสือยินยอมให้ใช้ประโยชน์ในที่ดิน:**
...
---[SECTION:MINIMUM_AREA]---

### **เกณฑ์เนื้อที่/จำนวนขั้นต่ำ สำหรับการขึ้นทะเบียนเกษตรกร (ภาคผนวก 8)**

นี่คือเกณฑ์ "ด่านแรก" ที่ใช้พิจารณาว่ากิจกรรมการเกษตรนั้นๆ มีขนาดใหญ่พอที่จะรับขึ้นทะเบียนได้หรือไม่ โดยเกษตรกรจะต้องผ่านเกณฑ์อย่างน้อยหนึ่งข้อในรายการต่อไปนี้

#### **กลุ่มที่ 1: พืชไร่และข้าว**
*   **ข้าว:** ต้องมีเนื้อที่เพาะปลูก ตั้งแต่ **1 ไร่** ขึ้นไป
*   **พืชไร่:** ต้องมีเนื้อที่เพาะปลูกพืชไร่ชนิดใดชนิดหนึ่ง หรือหลายชนิดรวมกัน ตั้งแต่ **1 ไร่** ขึ้นไป

#### **กลุ่มที่ 2: พืชสวน (ผัก, ไม้ดอก, สมุนไพร)**
*   **พืชผัก / ไม้ดอก / ไม้ประดับ / สมุนไพร:** ต้องมีเนื้อที่เพาะปลูกชนิดใดชนิดหนึ่ง หรือหลายชนิดรวมกัน ตั้งแต่ **1 งาน** ขึ้นไป
    *   *หมายเหตุ: หากปลูกหลายชนิด ต้องแจ้งขึ้นทะเบียนในคราวเดียวกัน*

#### **กลุ่มที่ 3: ไม้ยืนต้นและสวนป่า**
*   **ไม้ผล หรือ ไม้ยืนต้น (แบบสวนเดี่ยว):** ต้องมีเนื้อที่เพาะปลูกชนิดใดชนิดหนึ่ง หรือหลายชนิดรวมกัน ตั้งแต่ **1 ไร่** ขึ้นไป **และ** มีจำนวนต้นตามเกณฑ์ที่กำหนด (อ้างอิง SECTION:PLANTING_DENSITY)
*   **ปลูกสวนป่า หรือ ปลูกป่าเศรษฐกิจ (แบบสวนเฉพาะ):** ต้องมีเนื้อที่เพาะปลูกชนิดใดชนิดหนึ่ง หรือหลายชนิดรวมกัน ตั้งแต่ **1 ไร่** ขึ้นไป **และ** มีจำนวนต้นไม้รวมกันตั้งแต่ **100 ต้น** ขึ้นไป

#### **กลุ่มที่ 4: เกษตรแบบผสมผสาน**
*   **ปลูกพืชแบบสวนแซม / สวนผสม / เกษตรกรรมยั่งยืน (ซึ่งอาจมีการเลี้ยงสัตว์/ประมงร่วมด้วย):** ต้องมีเนื้อที่รวมของกิจกรรมทั้งหมด ตั้งแต่ **1 ไร่** ขึ้นไป

#### **กลุ่มที่ 5: การเพาะปลูกในโรงเรือนและกิจกรรมที่ใช้พื้นที่น้อย (Special & Indoor Farming)**

กลุ่มนี้ครอบคลุมกิจกรรมการเกษตรที่ไม่ใช่การปลูกพืชในแปลงดินแบบดั้งเดิม แต่เป็นการเพาะเลี้ยงในภาชนะ, โรงเรือน, หรือพื้นที่ควบคุม ซึ่งมีเกณฑ์การนับพื้นที่และเงื่อนไขที่แตกต่างกันไป

*   **เพาะเห็ด / ทำผักงอก (Mushroom / Sprout Cultivation)**
    *   **นิยาม:** รวมถึงการเพาะเห็ดทุกชนิด (เช่น เห็ดนางฟ้า, เห็ดฟาง) และการเพาะต้นอ่อนเพื่อบริโภค (เช่น ต้นอ่อนทานตะวัน, ต้นอ่อนถั่วลันเตา, ถั่วงอก)
    *   **เกณฑ์ขั้นต่ำ:** ต้องมี **พื้นที่เพาะเลี้ยงรวมทั้งหมด** ตั้งแต่ **30 ตารางเมตร** ขึ้นไป
    *   **วิธีการนับพื้นที่:** ให้นับรวม "พื้นที่ผิว" ที่ใช้ในการเพาะปลูกจริงทั้งหมด เช่น พื้นที่ของก้อนเชื้อ, พื้นที่ของชั้นวางทุกชั้น, หรือพื้นที่ของถาดเพาะทั้งหมดรวมกัน ไม่ใช่แค่ขนาดของโรงเรือน

*   **เพาะเลี้ยงแหนแดง หรือ ผำ (ไข่น้ำ) (Azolla / Watermeal Cultivation)**
    *   **นิยาม:** เป็นการเพาะเลี้ยงพืชน้ำขนาดเล็กเพื่อใช้เป็นอาหารสัตว์, ปุ๋ยพืชสด, หรือเพื่อการบริโภค
    *   **เกณฑ์ขั้นต่ำ:** ต้องผ่านเกณฑ์อย่างใดอย่างหนึ่งต่อไปนี้:
        *   **กรณีเลี้ยงในบ่อดิน:** ต้องมีเนื้อที่ผิวน้ำของบ่อ ตั้งแต่ **100 ตารางเมตร (หรือ 25 ตารางวา)** ขึ้นไป
        *   **กรณีเลี้ยงในบ่อซีเมนต์, วงบ่อ, หรือภาชนะอื่นๆ:** ต้องมีเนื้อที่ผิวน้ำ **รวมกันทั้งหมด** ตั้งแต่ **50 ตารางเมตร (หรือ 12.5 ตารางวา)** ขึ้นไป
        *   **กรณีเลี้ยงในภาชนะขนาดเล็ก (เข้าเกณฑ์จำนวน):** หากพื้นที่รวมไม่ถึง 50 ตร.ม. จะพิจารณาจากจำนวนภาชนะแทน เช่น
            *   เลี้ยงใน **วงบ่อซีเมนต์ขนาด 80x40 ซม.** ต้องมีจำนวนไม่น้อยกว่า **15 วงบ่อ**
            *   เลี้ยงใน **วงบ่อซีเมนต์ขนาด 60x40 ซม.** ต้องมีจำนวนไม่น้อยกว่า **20 วงบ่อ**
            *   เลี้ยงใน **วงบ่อซีเมนต์ขนาด 60x30 ซม.** ต้องมีจำนวนไม่น้อยกว่า **28 วงบ่อ**
    *   **วิธีการนับพื้นที่:** ให้นับรวมพื้นที่บ่อทั้งหมดที่ใช้ในกระบวนการ ตั้งแต่บ่อแม่พันธุ์, บ่อเพาะเลี้ยง, ไปจนถึงบ่อสำหรับเก็บผลผลิต

*   **เพาะปลูกพืชในระบบโรงเรือนถาวร (Permanent Greenhouse Farming)**
    *   **นิยาม:** การปลูกพืชใดๆ ก็ตาม (เช่น เมล่อน, มะเขือเทศ, พริกหวาน, ผักสลัด) ในโรงเรือนที่มีโครงสร้างถาวรและมีการควบคุมสภาพแวดล้อม
    *   **เกณฑ์ขั้นต่ำ:** ต้องมีขนาดพื้นที่ **ภายในโรงเรือน** ตั้งแต่ **72 ตารางเมตร** ขึ้นไป (เทียบเท่าขนาดมาตรฐานขั้นต่ำ 6x12 เมตร)
    *   **ข้อสังเกต:** เกณฑ์นี้พิจารณาที่ "ขนาดของโรงเรือน" โดยตรง ซึ่งแตกต่างจากการเพาะเห็ดที่นับ "พื้นที่เพาะเลี้ยง" จริง

#### **กลุ่มที่ 6: กิจกรรมปศุสัตว์และประมง (ที่กรมส่งเสริมการเกษตรรับผิดชอบ)**
*   **ทำนาเกลือสมุทร:** ต้องมีเนื้อที่ทำนาเกลือ ตั้งแต่ **1 ไร่** ขึ้นไป
*   **เพาะเลี้ยงแมลงเศรษฐกิจ:**
    *   **ผึ้งพันธุ์ หรือ ผึ้งโพรง:** ต้องมีจำนวน ตั้งแต่ **10 รัง** ขึ้นไป
    *   **ชันโรง:** ต้องมีจำนวน ตั้งแต่ **20 รัง** ขึ้นไป
    *   **จิ้งหรีด:** ต้องมีจำนวน ตั้งแต่ **10 บ่อ** ขึ้นไป (ขนาดมาตรฐาน 1.2x2.4 เมตร)
    *   **ด้วงสาคู หรือ ไส้เดือน:** ต้องมีพื้นที่เพาะเลี้ยง ตั้งแต่ **30 ตารางเมตร** ขึ้นไป
    *   **ครั่ง:** ต้องเลี้ยงบนต้นไม้ (ต้นก้ามปู/พุทรา) ตั้งแต่ **5 ต้น** ขึ้นไป

#### **กลุ่มที่ 7: พืชควบคุม (กัญชา, กัญชง, กระท่อม)**
*   **กัญชง หรือ กัญชา (ปลูกเป็นสมุนไพร):**
    *   **ปลูกกลางแจ้ง:** ต้องมีเนื้อที่ ตั้งแต่ **30 ตารางเมตร (7.5 ตารางวา)** ขึ้นไป **และ** มีจำนวนต้นไม่น้อยกว่า **6 ต้น**
    *   **ปลูกในโรงเรือน:** ต้องมีขนาดโรงเรือน ตั้งแต่ **30 ตารางเมตร** ขึ้นไป
*   **กัญชง (ปลูกเป็นพืชไร่เอาเส้นใย):** ต้องมีเนื้อที่เพาะปลูก ตั้งแต่ **1 ไร่** ขึ้นไป
*   **กระท่อม:** ต้องมีเนื้อที่เพาะปลูก ตั้งแต่ **1 งาน** ขึ้นไป **และ** มีจำนวนต้นไม่น้อยกว่า **20 ต้น**

---
### **ข้อยกเว้นที่สำคัญที่สุด: กฎรายได้ขั้นต่ำ 8,000 บาท**

**ย้ำอีกครั้ง:** หากเกษตรกรประกอบกิจกรรมหลายอย่างรวมกัน แต่ **ไม่มีกิจกรรมใดเลยที่ผ่านเกณฑ์ขั้นต่ำที่ระบุไว้ข้างต้น** เกษตรกร **ยังคงสามารถขึ้นทะเบียนได้** หากสามารถยืนยันได้ว่า **มีรายได้ที่คาดว่าจะได้รับจากทุกกิจกรรมการเกษตรรวมกัน ตั้งแต่ 8,000 บาทต่อปีขึ้นไป**
